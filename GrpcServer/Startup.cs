...
namespace WebServices
{
    public class Startup
    {
            ...
            public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //var reflectionServiceImpl = new ReflectionServiceImpl(Deltaban.Grpc.SearchService.Descriptor);
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapGrpcService<SumServiceConcrete>();
                endpoints.MapGrpcService<ManyServicesService>();
